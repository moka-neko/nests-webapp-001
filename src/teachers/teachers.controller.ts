...
export class TeachersController {
  ...
  /**
   * API #13: GET /api/v1/teachers/applications/{id}
   * 指定 ID の先生応募データを取得する。
   */
  @Get(':id')
  @ApiOperation({
    summary: '先生の応募データ詳細取得',
    description: '指定 ID の先生応募データを取得する。',
  })
  @ApiParam({
    name: 'id',
  ...
  async findOne(@Param('id') id: string): Promise<TeacherApplicationResponseDto> {
